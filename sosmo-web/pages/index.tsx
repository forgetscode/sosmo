                      ...
                      <div key ={p.id}>
                          <div className="flex-1 md:mb-5">
                              <NextLink href="/post/[id]" as={`/post/${p.id}`}>
                                    <div className=" cursor-pointer flex flex-col bg-white md:flex-row md:rounded-lg shadow-lg border 
                                    border-slate-200 transform transition-all hover:scale-105 hover:border-slate-900">
